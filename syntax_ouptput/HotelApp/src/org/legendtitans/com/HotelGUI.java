...
public class HotelGUI implements ActionListener, ChangeListener {
	...
	public void review() {
		...
		review[16] = new JLabel("Payment Type: " + paymentType.getText());
	...
	public void update() {
		...
		review[16].setText("Payment Type: " + paymentType.getText());
		...
		if(nameH.getText().equals("") || addressLine1H.getText().equals("") || addressLine2H.getText().equals("") || cityH.getText().equals("") || stateH.getText().equals("") || zipH.getText().equals("") || firstName.getText().equals("") || lastName.getText().equals("")) {
			...
			submit.setEnabled(false);
		} else if(paymentAmount.getText().equals("") || paymentType.getText().equals("") || bookingDate.getText().equals("") || numberOfRooms.getText().equals("")) {
			submit.setEnabled(false);
		} else {
